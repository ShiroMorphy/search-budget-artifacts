...
echo "================================================================="
echo "Paper 1 Reproducibility Pipeline (Physical Review E)"
...
echo "[6/7] Zero-cost diagnostic bracket on the empirical trajectory (Fig. 2)..."
...
echo "PDF:        manuscript/paper1.pdf"
