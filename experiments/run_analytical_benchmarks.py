...
Comparing Fixed-step RGD (budgets 4/35, 12/100, 25/150) against
Adaptive Armijo, Riemannian Barzilai-Borwein (RBB), and Wen-Yin Cayley.
"""
...
def main():
    ...
    benchmarks = [
        ...
        ("Adaptive Armijo 12/100", lambda A, S, s2, q, **kw: optimize_adaptive_armijo(A, S, s2, q, n_restarts=12, max_iter=100, **kw)),
