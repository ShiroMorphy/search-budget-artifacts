"""
Zero-Cost Diagnostic Bracket on the Empirical Regularization Trajectory
=======================================================================
...
quantities are averaged across windows:
  ...
  q1_feasible_cefi  a feasible projection witness at q = 1 obtained by adaptive
                    Armijo line search.
...
WITNESS_METHODS = (optimize_adaptive_armijo, optimize_rbb, optimize_wen_yin)
